...
TIMESTEPS = 10000
RUN_NAME = f"DQN+HER_{env.width-2}x{env.height-2}_{goal_selection_strategy}_{env.GOAL_TYPE}_{timestamp}"
...
for i in itertools.count(1):
    try:
        ...
        print(f"Meilenstein erreicht: {TIMESTEPS * i} Schritte. Modell gespeichert unter: {save_path}")
